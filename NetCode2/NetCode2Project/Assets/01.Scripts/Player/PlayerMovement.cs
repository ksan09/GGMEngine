...
public class PlayerMovement : NetworkBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        float halfWidth = orthSize * ratio;
        float halfHeight = orthSize;
    ...
    private void HandleDrag()
    {
        ...
        float nextXPos = Mathf.Clamp(
            _playerStartPos.x + xDiff,
            _camRect.xMin + halfSprite,
            _camRect.xMax - halfSprite);
